...
#define  PWM15_PWM0_SW(Pin)		{PWM0CR = (PWM0CR & ~0x18) | (Pin << 3);}
#define  PWM15_PWM1_SW(Pin)		{PWM1CR = (PWM1CR & ~0x18) | (Pin << 3);}
#define  PWM15_PWM2_SW(Pin)		{PWM2CR = (PWM2CR & ~0x18) | (Pin << 3);}
#define  PWM15_PWM3_SW(Pin)		{PWM3CR = (PWM3CR & ~0x18) | (Pin << 3);}
#define  PWM15_PWM4_SW(Pin)		{PWM4CR = (PWM4CR & ~0x18) | (Pin << 3);}
#define  PWM15_PWM5_SW(Pin)		{PWM5CR = (PWM5CR & ~0x18) | (Pin << 3);}
#define  PWM15_PWM6_SW(Pin)		{PWM6CR = (PWM6CR & ~0x18) | (Pin << 3);}
#define  PWM15_PWM7_SW(Pin)		{PWM7CR = (PWM7CR & ~0x18) | (Pin << 3);}
